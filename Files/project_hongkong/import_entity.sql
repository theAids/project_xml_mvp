...
UPDATE Entity_tbl SET
	...
	[CP1 Jurisdiction 1] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 Jurisdiction 1]) OR CP1 CountryCode=UPPER([CP1 Jurisdiction 1])),NULL),
	[CP1 Jurisdiction 2] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 Jurisdiction 2]) OR CP1 CountryCode=UPPER([CP1 Jurisdiction 2])),NULL),
	[CP1 Jurisdiction 3] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 Jurisdiction 3]) OR CP1 CountryCode=UPPER([CP1 Jurisdiction 3])),NULL),
	[CP1 Country] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 Country]) OR CP1 CountryCode=UPPER([CP1 Country])),NULL),
	[CP1 Place of birth] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 Place of birth]) OR CP1 CountryCode=UPPER([CP1 Place of birth])),NULL),
	[CP1 TIN 1 issuedBy] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 TIN 1 issuedBy]) OR CP1 CountryCode=UPPER([CP1 TIN 1 issuedBy])),NULL),
	[CP1 TIN 2 issuedBy] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 TIN 2 issuedBy]) OR CP1 CountryCode=UPPER([CP1 TIN 2 issuedBy])),NULL),
	[CP1 TIN 3 issuedBy] = ISNULL((SELECT CP1 CountryCode FROM CP1 CountryList WHERE CP1 CountryName=UPPER([CP1 TIN 3 issuedB]) OR CP1 CountryCode=UPPER([CP1 TIN 3 issuedB])),NULL),
	
	/* Controlling Person 2 */
	[CP2 Jurisdiction 1] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 Jurisdiction 1]) OR CP2 CountryCode=UPPER([CP2 Jurisdiction 1])),NULL),
	[CP2 Jurisdiction 2] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 Jurisdiction 2]) OR CP2 CountryCode=UPPER([CP2 Jurisdiction 2])),NULL),
	[CP2 Jurisdiction 3] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 Jurisdiction 3]) OR CP2 CountryCode=UPPER([CP2 Jurisdiction 3])),NULL),
	[CP2 Country] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 Country]) OR CP2 CountryCode=UPPER([CP2 Country])),NULL),
	[CP2 Place of birth] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 Place of birth]) OR CP2 CountryCode=UPPER([CP2 Place of birth])),NULL),
	[CP2 TIN 1 issuedBy] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 TIN 1 issuedBy]) OR CP2 CountryCode=UPPER([CP2 TIN 1 issuedBy])),NULL),
	[CP2 TIN 2 issuedBy] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 TIN 2 issuedBy]) OR CP2 CountryCode=UPPER([CP2 TIN 2 issuedBy])),NULL),
	[CP2 TIN 3 issuedBy] = ISNULL((SELECT CP2 CountryCode FROM CP2 CountryList WHERE CP2 CountryName=UPPER([CP2 TIN 3 issuedB]) OR CP2 CountryCode=UPPER([CP2 TIN 3 issuedB])),NULL),
	
	/* Controlling Person 3 */
	[CP3 Jurisdiction 1] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 Jurisdiction 1]) OR CP3 CountryCode=UPPER([CP3 Jurisdiction 1])),NULL),
	[CP3 Jurisdiction 2] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 Jurisdiction 2]) OR CP3 CountryCode=UPPER([CP3 Jurisdiction 2])),NULL),
	[CP3 Jurisdiction 3] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 Jurisdiction 3]) OR CP3 CountryCode=UPPER([CP3 Jurisdiction 3])),NULL),
	[CP3 Country] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 Country]) OR CP3 CountryCode=UPPER([CP3 Country])),NULL),
	[CP3 Place of birth] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 Place of birth]) OR CP3 CountryCode=UPPER([CP3 Place of birth])),NULL),
	[CP3 TIN 1 issuedBy] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 TIN 1 issuedBy]) OR CP3 CountryCode=UPPER([CP3 TIN 1 issuedBy])),NULL),
	[CP3 TIN 2 issuedBy] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 TIN 2 issuedBy]) OR CP3 CountryCode=UPPER([CP3 TIN 2 issuedBy])),NULL),
	[CP3 TIN 3 issuedBy] = ISNULL((SELECT CP3 CountryCode FROM CP3 CountryList WHERE CP3 CountryName=UPPER([CP3 TIN 3 issuedB]) OR CP3 CountryCode=UPPER([CP3 TIN 3 issuedB])),NULL)
...
DECLARE @CurrencyCodenvarchar(255)  
...
BEGIN
	...
	IF(@TIN2 IS NOT NULL)
		INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
		VALUES(@TIN2,@TIN1issuedBy,'TIN',@EntityId)
	IF(@TIN3 IS NOT NULL)
		INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
		VALUES(@TIN3,@TIN1Ctry,'TIN',@EntityId)
	
		/* Controlling Person 1 */
		--CP1 Individual AcctHolder and Account Mapping
		IF (@CP1LastName IS NOT NULL)
			INSERT INTO ControllingPerson(AcctNumber,PId)
			VALUES(@AccountNumber,@EntityId)
	
		--CP1 Individual Account Holder Info
		IF (@CP1LastName IS NOT NULL AND @CP1LastName NOT IN (SELECT DISTINCT LastName FROM dbo.Person))
		...
		INSERT INTO Address(FreeLine, City, CountryCode, P_Ent_Id)
		VALUES(@CP1AddressFree, @CP1City,@CP1Country, @EntityId)
		
		--CP1 Individual ResCountry
		IF(@CP1Jurisdiction1 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP1Jurisdiction1,1)
		IF(@CP1Jurisdiction2 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP1Jurisdiction2,1)
		IF(@CP1Jurisdiction3 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP1Jurisdiction3,1)
		
		--CP1 Individual TIN
		IF(@CP1TIN1 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP1TIN1,@CP1TIN1Ctry,'TIN',@EntityId)
		IF(@CP1TIN2 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP1TIN2,@CP1TIN1Ctry,'TIN',@EntityId)
		IF(@CP1TIN3 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP1TIN3,@CP1TIN1Ctry,'TIN',@EntityId)
		...
		IF (@CP2LastName IS NOT NULL AND @CP2LastName NOT IN (SELECT DISTINCT LastName FROM dbo.Person))
			INSERT INTO Person(FirstName, LastName, BirthDate, BirthCountry)
			VALUES(@CP2FirstName, @CP2LastName, @CP2BirthDate, @CP2BirthPlace)
			
		--CP2 Individual Address
		INSERT INTO Address(FreeLine, City, CountryCode, P_Ent_Id)
		VALUES(@CP2AddressFree, @CP2City,@CP2Country, @EntityId)
		
		--CP2 Individual ResCountry
		IF(@CP2Jurisdiction1 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP2Jurisdiction1,1)
		IF(@CP2Jurisdiction2 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP2Jurisdiction2,1)
		IF(@CP2Jurisdiction3 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP2Jurisdiction3,1)
		
		--CP2 Individual TIN
		IF(@CP2TIN1 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP2TIN1,@CP2TIN1Ctry,'TIN',@EntityId)
		IF(@CP2TIN2 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP2TIN2,@CP2TIN1Ctry,'TIN',@EntityId)
		IF(@CP2TIN3 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP2TIN3,@CP2TIN1Ctry,'TIN',@EntityId)
		...
		IF (@CP3LastName IS NOT NULL AND @CP3LastName NOT IN (SELECT DISTINCT LastName FROM dbo.Person))
			INSERT INTO Person(FirstName, LastName, BirthDate, BirthCountry)
			VALUES(@CP3FirstName, @CP3LastName, @CP3BirthDate, @CP3BirthPlace)
			
		--CP3 Individual Address
		INSERT INTO Address(FreeLine, City, CountryCode, P_Ent_Id)
		VALUES(@CP3AddressFree, @CP3City,@CP3Country, @EntityId)
		
		--CP3 Individual ResCountry
		IF(@CP3Jurisdiction1 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP3Jurisdiction1,1)
		IF(@CP3Jurisdiction2 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP3Jurisdiction2,1)
		IF(@CP3Jurisdiction3 IS NOT NULL)
			INSERT INTO ResCountryCode(P_Ent_Id,CountryCode,isReportable)
			VALUES(@EntityId,@CP3Jurisdiction3,1)
		
		--CP3 Individual TIN
		IF(@CP3TIN1 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP3TIN1,@CP3TIN1Ctry,'TIN',@EntityId)
		IF(@CP3TIN2 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP3TIN2,@CP3TIN1Ctry,'TIN',@EntityId)
		IF(@CP3TIN3 IS NOT NULL)
			INSERT INTO INType(Value,CountryCode,IType,P_Ent_Id)
			VALUES(@CP3TIN3,@CP3TIN1Ctry,'TIN',@EntityId)
